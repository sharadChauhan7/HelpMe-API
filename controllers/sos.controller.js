...
export const sendSoS = async (req, res) => {
    ...
    const { location, name = "Sharad", gender = "Girl", k = 1 } = req.body;
    ...
    const points = [
        { coordinates: [27.5312, 79.8455], phone: '+919634879999' }, // Hraryana
        { coordinates: [27.497462965783534, 77.68341135617429], phone: '+919634879999' }, // Mathura
        { coordinates: [27.1752554, 78.0098161], phone: '+919634879999' },  // Agra
    ];
